package com.example.mygaode.offlinemap;
 ...
 * AMapV2地图中简单介绍离线地图下载
 */
public class GetOfflineMapActivity extends Activity implements
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case UPDATE_LIST:
				...
				break;
			case SHOW_MSG:
//				Toast.makeText(GetOfflineMapActivity.this, (String) msg.obj,
//						Toast.LENGTH_SHORT).show()
				ToastUtil.showShortToast(GetOfflineMapActivity.this, (String)msg.obj);
				break;
	...
	public void initAllCityList() {
		// 扩展列表
		View provinceContainer = LayoutInflater.from(GetOfflineMapActivity.this)
	...
	public void initDownloadedList() {
		mDownLoadedList = (ListView) LayoutInflater.from(
				GetOfflineMapActivity.this).inflate(
	...
	public void onDownload(int status, int completeCode, String downName) {
		...
		case OfflineMapStatus.EXCEPTION_NETWORK_LOADING:
			Log.e("amap-download", "download: " + " EXCEPTION_NETWORK_LOADING "
					+ downName);
			Toast.makeText(GetOfflineMapActivity.this, "Network anomalies", Toast.LENGTH_SHORT)
					.show();
			amapManager.pause();
			break;
