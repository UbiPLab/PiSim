...
//        Map<String, BigInteger> clKeyMap;
//        clKeyMap = generateClSignKeyPair();
//        Map<String, BigInteger> signMap;
//        signMap = signature("123456789qwerq", clKeyMap.get("PK_d1"), clKeyMap.get("PK_d2"), clKeyMap.get("PK_d3"), clKeyMap.get("PK_n"), clKeyMap.get("SK_p"));
//        verify("123456789qwerq", clKeyMap.get("PK_d1"), clKeyMap.get("PK_d2"), clKeyMap.get("PK_d3"), clKeyMap.get("PK_n"), signMap.get("v"), signMap.get("e"), signMap.get("s"));
//
//    }
}
