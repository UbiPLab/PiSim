...
public class RSA {
    ...
    public static String encrypt(String input, String publicKey) throws Exception {
        ...
        return Base64.encodeBytes(cipher.doFinal(temp));
    }
    ...
    public static String decrypt(String input, String privateKey) throws Exception {
        ...
        return new String(Base64.decode( Base64.encodeBytes(cipher.doFinal(temp))));
    }
...
//            String jiami = encrypt(aaa, KeyMap.get("publicKey"));
//            System.out.println("加密后结果：" + jiami);
//            String jiemi = decrypt(jiami, KeyMap.get("privateKey"));
//            System.out.println("解密后结果: " + jiemi);
//            String sign = signature(aaa,KeyMap.get("privateKey"));
//            System.out.println("签名:"+sign);
//            System.out.println("验证结果:"+verify(aaa,sign,KeyMap.get("publicKey")));
//
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
