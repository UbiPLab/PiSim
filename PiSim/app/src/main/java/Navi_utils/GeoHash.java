...
public class GeoHash {
    ...
    private int latLength = 17; //纬度转化为二进制长度
    private int lngLength = 18; //经度转化为二进制长度
    ...
    public GeoHash(LocationBean locationBean) {
        location = new LocationBean(locationBean.getLat(),locationBean.getLat());
        setMinLatLng();
    }
     ...
     * @return
     */
    public boolean[] getGeoHashArray(){
        return getGeoBinary(location.getLat(),location.getLng());
    }
